...
Q3.1:
Rs < 0.2/0.595238095^2 = 0.564931855 ~= 0.5Ohms;

Q3.2:
Calcs:
Il = VA/V = 7.5/12.6 = 0.595238095A
Z = V/I = 12.6/0.595238095 = 21.168Ohms
R_l = sqrt(Z^2 - X^2) - 0.5 = sqrt(21.168^2  - (4*10^-3*500*2*pi)^2) - 0.5 = 16.5343933Ohms

Il = VA/V = 7.5/15.4 = 0.487012987A
Z = V/I = 15.4/0.487012987 = 31.6213333Ohms
R_l = sqrt(Z^2 - X^2) - 0.5 = sqrt(31.6213333^2  - (4*10^-3*500*2*pi)^2) - 0.5 = 28.5171509Ohms

Vis(pk) is just 0.5*Il*sqrt(2)
...
|----------|------|------|------|------|------|------|------|
| 7.5VA | 12.6V | 16.5Ohm | 0.595A | 0.421V | 0.420V | 0.1770125W | 0.16245W |
| 7.5VA | 15.4V | 28.5Ohm | 0.487A | 0.344V | 0.346V | 0.1185845W | 0.1169W |
| 2.5VA | 15.4V | 93.5Ohm | 0.162A | 0.115V | 0.112 V| 0.013122W | 0.13013W |

Q3.3:
| Parameter | Bigger Rs | Smaller Rs |
|----------|------|------|
| SNR | High | Lower |
